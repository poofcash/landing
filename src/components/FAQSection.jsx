...
export const FAQSection = () => {
  return (
    <>
      <Text id="faq" variant="styles.h3">
        FAQ
      </Text>
      <Container>
        <Box sx={{ bg: "grey", height: 200, mb: 4, mt: 2, width: "100%" }} />
        <Grid
          sx={{
        ...
        >
          <Container>
            ...
            <br />
            <Text>
              Imagine having a bank account, but everyone could see your
          ...
          <Container>
            ...
            <Text>
              ...
              `77af0c5`. We did not modify the contracts from that commit, and
              those contracts have been audited by{" "}
              <a

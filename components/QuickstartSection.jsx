  ...
  return (
    ...
    >
      <Container>
        ...
        <Text>
          Deposit tokens into the smart contract. You will then receive a secret
          note to redeem those tokens in the future.
        </Text>
      </Container>
      <Container>
        <Box sx={{ bg: "grey", height: 200, width: "100%" }} />
      ...
      <Container>
        <Box sx={{ bg: "grey", height: 200, width: "100%" }} />
        <Text>
          Withdraw tokens by specifying the secret note from the first step and
          a recipient address. The recipient address can be a completely empty
          wallet.
        </Text>
      </Container>
    </Grid>

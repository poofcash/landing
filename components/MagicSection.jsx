    ...
    <Grid columns={[2]} id="magic" sx={{ mb: 6 }}>
      ...
      <Container>
        <ul>
          ...
          <li>
            During the withdrawal, you supply your secret and recipient address
            to Poof. Poof creates a proof using your secret and the recipient
            address and sends it to a Relayer node to execute the transaction.
            <br />
            NOTE: Relayer nodes are unable to tamper with your recipient address
            because it is <strong>practically impossible</strong> to modify the
            proof.
          </li>
          <li>
            Poof’s smart contract verifies your proof. If successful, it directs
            the originally deposited funds to the recipient address and refunds
            gas and fees to the relayer.
          </li>
          <li>
